<template>
	<view class="articleList">
		<view class="item" v-for="(item,index) in posts" :key="index">
			<view @tap="gotoDetail(item.id)" class="normal-post" v-if="item.format=='standard'">
				...
				<view class="cover">
					<image :src="item.meta.thumbnail" mode="aspectFill"></image>
				</view>
			</view>
			<view @tap="gotoDetail(item.id)" class="video-post" v-if="item.format=='video'">
				<view class="inner">
			...
			<view @tap="gotoDetail(item.id)" class="gallery-post" v-if="item.format=='gallery'">
				<view class="title">
					{{item.title.rendered}}
				</view>
