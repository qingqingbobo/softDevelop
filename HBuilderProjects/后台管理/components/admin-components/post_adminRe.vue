		    ...
		    <view style="width: 500upx;display: flex;background-color: #FFFFFF;flex-direction: column;box-shadow: 1px 1px 1px #808080;border-radius: 2upx;">
		        ...
		        <view style="border-bottom: 1px solid #DCDFE6;color: #606266;font-size: 15px;width: 440upx;padding: 30upx;display: flex;flex-direction: column;justify-content: center;align-items: center;">
					...
					<view style="width: 360upx;padding: 15upx;display: flex;flex-direction: row;align-items: center;">
						...
						文章名
						<input v-model="post_name" :value="post_name" @click='confirm0' :class="input_confirm==0?'input_confirm':'input_account'" class="" style="" />
					</view>
					<view style="width: 360upx;padding: 15upx;display: flex;flex-direction: row;align-items: center;">
						作  者
						<input v-model="post_author" :value="post_author" @click='confirm1' class="" :class="input_confirm==1?'input_confirm':'input_account'" style="" />
					</view>
					<view style="width: 360upx;padding: 15upx;display: flex;flex-direction: row;align-items: center;">
						阅读量
		    ...
		    <view style="width: 500upx;display: flex;background-color: #FFFFFF;flex-direction: column;box-shadow: 1px 1px 1px #808080;border-radius: 2upx;">
		        ...
		        <view style="border-bottom: 1px solid #DCDFE6;color: #606266;font-size: 15px;width: 440upx;padding: 30upx;display: flex;flex-direction: column;justify-content: center;align-items: center;padding: 5upx;">
					...
					<view style="width: 360upx;padding: 15upx;display: flex;flex-direction: row;align-items: center;">
						...
						账号
						<input v-model="add_post_name" @click='confirm2' :class="input_confirm==2?'input_confirm':'input_account'" class="" style="" />
					</view>
					<view style="width: 360upx;padding: 15upx;display: flex;flex-direction: row;align-items: center;">
						<view  style="color: red;">
							*
						...
						密码
						<input v-model="add_post_author" @click='confirm3' class="" :class="input_confirm==3?'input_confirm':'input_account'" style="" />
					</view>
				</view>
				<view style="width: 100%;display: flex;align-items: center;font-size: 12px;color: #FFFFFF;">
					<view style="width: 95%;display: flex;flex-direction: row;align-items: center;padding: 15upx;">
	...
	export default{
		...
		methods:{
			...
			alter_sure(){
				...
				var that = this;
				console.log(that.post_name);

				uni.request({
					url:'http://localhost:8080/editpost',
					method: "POST",
					data:{
							title: that.post_name,
							postid: that.person_id							
					},
			...
			alter:function(e){
				...
				console.log(e)
				this.post_name = e.post_name
				this.post_author = e.post_author
				this.post_readnum = e.post_readnum
				this.person_id = e.id
			},
