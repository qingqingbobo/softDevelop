	...
	<view class="content">
		...
		<view class="fix-card">
			<view class="flex-wrp flex-other">
				...
				<!-- <view @tap="changePassWords()" class="flex-item">
					<text>修改密码</text>
		...
		<view class="fix-card" v-if="logined">
			<view class="flex-wrp flex-other">
				<view @tap="changePassWords()" class="flex-item">
					<text>修改密码</text>
					<view class="value">修改密码</view>
	...
	export default {
		...
		methods: {
			...
			changePassWords: function() {
							console.log("这只是一个测试1111");
							console.log(this.user.password);
							console.log("这只是一个测试2222");
							uni.setStorageSync("yonghu2",this.user);
							uni.navigateTo({
								url:'/pages/editme/changePasswords'
							});
			}
